use mcp_set::types::{McpServerConfig, PackageManager, Source, Transport};
use mcp_set::{Agent, Scope};
use std::fs;
...
fn install_command_claude_code_creates_config() {
    ...
    let results =
        mcp_set::install_with_home(&config, &[Agent::ClaudeCode], Scope::Global, tmp.path());
...
fn install_command_cursor_creates_config() {
    ...
    let results = mcp_set::install_with_home(&config, &[Agent::Cursor], Scope::Global, tmp.path());
...
fn install_url_vscode() {
    ...
    let results = mcp_set::install_with_home(&config, &[Agent::VsCode], Scope::Global, tmp.path());
...
fn install_goose_yaml() {
    ...
    let results = mcp_set::install_with_home(&config, &[Agent::Goose], Scope::Global, tmp.path());
...
fn install_zed_json() {
    ...
    let results = mcp_set::install_with_home(&config, &[Agent::Zed], Scope::Global, tmp.path());
...
fn install_codex_toml() {
    ...
    let results = mcp_set::install_with_home(&config, &[Agent::Codex], Scope::Global, tmp.path());
...
fn install_multiple_agents() {
    ...
    let results = mcp_set::install_with_home(
        &config,
...
fn detect_finds_installed_agents() {
    ...
    let detected = mcp_set::detect_agents_with_home(false, tmp.path());
...
fn install_copilot_has_tools() {
    ...
    let results =
        mcp_set::install_with_home(&config, &[Agent::GithubCopilot], Scope::Global, tmp.path());
...
fn install_opencode_command_array() {
    ...
    let results =
        mcp_set::install_with_home(&config, &[Agent::OpenCode], Scope::Global, tmp.path());
